...
class AnimalProducts
{
    ...
    // Constructor method 
    public function __construct(string $image, string $title, string $price, string $description, string $category, int $quantity, bool $available, string $article_type, string $icon_category)
    {
        $this->image = $image;
        $this->title = $title;
        $this->price = $price;
